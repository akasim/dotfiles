...
```bash
git clone https://github.com/akasim/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/akasim/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh}
```
...
[welcome](https://github.com/akasim/dotfiles/issues)!
